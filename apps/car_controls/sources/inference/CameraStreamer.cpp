...
CameraStreamer::CameraStreamer(double scale)
	...
	yoloInferencer = std::make_shared<YOLOv5TRT>("/home/jetson/models/object-detection/models/yolov5m_updated.engine", "/home/jetson/models/object-detection/labels.txt");
