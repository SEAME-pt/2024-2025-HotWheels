 ...
 * @date 2025-01-31
 * 
 * @details This file contains the implementation of the MCP2515Configurator class, which configures the MCP2515 CAN controller.
 * 
 * @note This class is used to configure the MCP2515 CAN controller for communication.
 * 
 ...
 * @details This constructor initializes the MCP2515Configurator object with the specified SPI controller.
 */
 ...
 * @details This function cleans up the resources used putting the MCP2515 to default configuration.
 */
