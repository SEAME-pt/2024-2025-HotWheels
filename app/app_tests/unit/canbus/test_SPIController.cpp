 ...
 * @date 2025-01-30
 * 
 * @details This file contains unit tests for the SPIController class, using Google Test and Google Mock frameworks.
 */
...
protected:
     ...
     * 
     * @details This method is called before each test to set up the necessary objects.
     */
     ...
     * 
     * @details This method is called after each test to clean up the objects created in SetUp().
     */
 ...
 * 
 * @details This test verifies that openDevice() does not throw an exception when the device opens successfully.
 * 
 ...
 * @brief Ensures that openDevice() throws an exception when the device fails to open.
 * 
 * @details This test verifies that openDevice() throws a runtime_error when the device fails to open.
 * 
 * @see SPIController::openDevice
 */
 ...
 * @brief Ensures that configure() does not throw an exception with valid parameters.
 * 
 * @details This test verifies that configure() does not throw an exception when called with valid parameters.
 * 
 ...
 * 
 * @details This test verifies that writeByte() does not throw an exception when writing a byte.
 * 
 ...
 * 
 * @details This test verifies that readByte() does not throw an exception when reading a byte.
 * 
 ...
 * 
 * @details This test verifies that spiTransfer() does not throw an exception when performing an SPI transfer.
 * 
 ...
 * 
 * @details This test verifies that closeDevice() does not throw an exception when the device closes successfully.
 * 
