...
public:
  /**
   * Constructor for the DisplayManager class. Initializes the display manager
   * and sets up connections.
   *
...
public slots:
  ...
  // Engine
  /**
   * Updates the engine data on the UI with the current direction and steering
   * angle.
   *
  ...
  // System
  /**
   * Updates the system time on the UI with the current date, time, and day of
   * the week.
   *
  ...
  /**
   * Updates the Wi-Fi status on the UI with the current connection status and
   * Wi-Fi name.
   *
...
private:
  Ui::CarManager
      *m_ui; /**< Pointer to the user interface for the car manager. */
};
