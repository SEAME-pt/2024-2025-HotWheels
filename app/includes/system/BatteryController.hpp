...
public:
     ...
     * Initializes the battery controller by setting up I2C communication and calibration.
     *
     ...
     * It calculates the battery percentage by measuring the bus voltage and shunt voltage.
     *
