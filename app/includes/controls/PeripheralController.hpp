...
public:
    /**
     * Constructor for the PeripheralController class, initializing the I2C communication for the servo and motor controllers.
     *
    ...
    /**
     * Destructor for the PeripheralController class, closing the I2C communication channels.
     */
