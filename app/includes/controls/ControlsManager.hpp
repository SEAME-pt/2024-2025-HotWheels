...
public:
     ...
     *
     * This constructor sets up the EngineController signals to be connected to the
     * ControlsManager signals. It initializes the JoysticksController with callbacks
     * for steering and speed. It also initializes and starts the joystick controller in a
     * separate thread.
     *
    ...
    /**
     * Destroys the ControlsManager instance, ensuring that the joystick controller
     * and its thread are properly cleaned up.
     *
     * This destructor stops the joystick controller, waits for the thread to finish,
     * and deletes the JoysticksController object.
     */
    ~ControlsManager();
     ...
     * not changed, the function returns early. It is called to switch between Manual
     * and Automatic modes.
     *
