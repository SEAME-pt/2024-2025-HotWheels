...
# Variables
SERVICE_NAME="car_controls.service"
SERVICE_PATH="/etc/systemd/system/$SERVICE_NAME"
SERVICE_USER="hotweels"
SERVICE_GROUP="hotweels"
EXECUTABLE_PATH="home/hotweels/service_executables/aarch64-car-controls"

# Service content
SERVICE_CONTENT="[Unit]
Description=Car Controls Service
After=network.target

[Service]
ExecStart=/home/hotweels/service_executables/aarch64-car-controls
Restart=always
User=hotweels
Group=hotweels
